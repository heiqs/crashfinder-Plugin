...
public class CrashFinderImplException {
	...
	public CrashFinderImplException(
	...
	public boolean isMissingInformation()
	{
		...
		{
			listener.getLogger().println("Path to jar of passing version is missing");
			return true;
		}else if(this.existPathToJarFailing() == false)
		{
			listener.getLogger().println("Path to jar of failing version is missing");
			return true;
