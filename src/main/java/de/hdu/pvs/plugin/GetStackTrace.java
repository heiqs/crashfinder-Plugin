...
public class GetStackTrace {
	...
	public GetStackTrace(String stackTrace, String pathToStackTrace,
	...
	public void handleAutomate() throws IOException {
		if (this.stackTrace.equals("automatically")) {
			...
			String pathToDirectoryStackTrace = SearchStackTrace
					.searchStackTraceContent(contentLog);

			this.listPathToStackTrace = SearchStackTrace
					.searchFileStackTrace(pathToDirectoryStackTrace);
			this.listFullNameFailedTest = ExtractionFailedTest
	...
	public void handleManual() {
		if (this.stackTrace.equals("manually") == true
			...
			try {
				...
				Logger.getLogger(GetStackTrace.class.getName()).log(
