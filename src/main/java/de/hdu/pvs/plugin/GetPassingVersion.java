 ...
 */
public class GetPassingVersion implements FilePath.FileCallable {
	...
	public GetPassingVersion(String behaviour, String git, String svn,
	...
	public void executeCommandCheckOutPassing() throws InterruptedException,
		...
		if (this.behaviour.equals("CommandLine") == true
			...
			String commandCheckOut = "cd " + pathToPassingDir + "  && "
					+ command;
			filePathPassing.act(new ExecutionCheckOut(build, listener,
