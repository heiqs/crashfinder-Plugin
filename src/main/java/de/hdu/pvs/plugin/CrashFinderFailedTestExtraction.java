...
public class CrashFinderFailedTestExtraction {
	...
	public static ArrayList<String> extractClassNameFailedTest(String input,
		...
		if (matcher.find()) {
			...
			listTest = CrashFinderFailedTestExtraction.extractAllTest(content, listener);
			listener.getLogger().println("Size test: " + listTest.size());
			listFailedTest = CrashFinderFailedTestExtraction.getFullNameFailedTest(
