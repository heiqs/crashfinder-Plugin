...
public class CrashFinderShowDumpsAction implements Action {
	...
	public CrashFinderShowDumpsAction(ArrayList<String> diffCoverageLoc2, ArrayList<String> diffCoverage2, ArrayList<String> failReader, ArrayList<String> passReader) {
